...
<c:set var="mainContent">
	...
	<form action="TestRegist.action" method="get" class="card card-body bg-light mb-4">
		<div class="row g-3">

			<div class="col-md-2">
				<label class="form-label">入学年度</label>
				<select name="f1" class="form-select" required>
					<option value="" disabled ${emptyf1 ? 'selected' : ''}>--------</option>
			...
			<div class="col-md-2">
				...
				<select name="f4" class="form-select" required>
					<option value="" disabled ${emptyf4 ? 'selected' : ''}>--------</option>
					...
					<tbody>
						<c:forEach var="item" items="${tests}">
							<tr>
								...
								<td>
									<!-- ★ 初回は空、エラー時は値保持 -->
									<input type="number" name="point_${item.student.no}"
